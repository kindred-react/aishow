...
export interface AgentFrameworkCompareRow {
  label: string;
  key: keyof Pick<AgentFramework, "org" | "tag" | "complexity" | "mcpMode" | "bestFor">;
}
...
async def run_example():
    ...
    agent = ChatAgent(
        system_message="根据任务，使用搜索工具获取信息。",
        tools=tools
    )
...
export const agentFrameworkCompareRows: AgentFrameworkCompareRow[] = [
  { label: "来源",    key: "org" },
  { label: "特色标签", key: "tag" },
  { label: "复杂度",  key: "complexity" },
  { label: "MCP集成", key: "mcpMode" },
